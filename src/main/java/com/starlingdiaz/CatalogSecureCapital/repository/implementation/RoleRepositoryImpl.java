...
import com.starlingdiaz.CatalogSecureCapital.rowmapper.RoleRowMapper;
...
import static com.starlingdiaz.CatalogSecureCapital.query.RoleQuery.*;
...
public class RoleRepositoryImpl implements RoleRepository<Role> {
    ...
    public Role getRoleByUserId(Long userId) {
        ...
        try {
            return jdbc.queryForObject(SELECT_ROLE_BY_ID_QUERY, of("role_id", userId), new RoleRowMapper());
        } catch (EmptyResultDataAccessException exception) {
            throw new ApiException("No role found for user id: " + ROLE_USER.name());
        } catch (Exception exception) {
